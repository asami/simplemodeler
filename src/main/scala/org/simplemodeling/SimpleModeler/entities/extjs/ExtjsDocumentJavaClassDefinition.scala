...
class ExtjsDocumentJavaClassDefinition(
  ...
  override protected def head_imports_Extension {
    jm_import("extjs.content.ContentValues")
    jm_import("extjs.os.Bundle")
    jm_import("extjs.os.Parcel")
    jm_import("extjs.os.Parcelable")
    jm_import("org.goldenport.extjs.feed.*")
  }
