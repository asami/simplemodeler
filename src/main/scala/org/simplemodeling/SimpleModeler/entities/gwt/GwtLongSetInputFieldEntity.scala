 ...
 */
class GwtLongSetInputFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class LongSetInputField extends ValueSetInputFieldBase {
}
"""
