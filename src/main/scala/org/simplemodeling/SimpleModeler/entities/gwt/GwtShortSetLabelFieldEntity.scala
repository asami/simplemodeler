 ...
 */
class GwtShortSetLabelFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class ShortSetLabelField extends ValueSetLabelFieldBase {
}
"""
