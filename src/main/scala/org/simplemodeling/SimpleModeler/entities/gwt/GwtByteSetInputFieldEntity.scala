 ...
 */
class GwtByteSetInputFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class ByteSetInputField extends ValueSetInputFieldBase {
}
"""
