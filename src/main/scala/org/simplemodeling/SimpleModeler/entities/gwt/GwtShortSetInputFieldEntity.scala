 ...
 */
class GwtShortSetInputFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class ShortSetInputField extends ValueSetInputFieldBase {
}
"""
