 ...
 */
class GwtStringSetInputFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class StringSetInputField extends ValueSetInputFieldBase {
}
"""
