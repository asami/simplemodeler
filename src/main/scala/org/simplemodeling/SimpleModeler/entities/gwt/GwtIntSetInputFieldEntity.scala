 ...
 */
class GwtIntSetInputFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class IntSetInputField extends ValueSetInputFieldBase {
}
"""
