 ...
 */
class GwtIntSetLabelFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class IntSetLabelField extends ValueSetLabelFieldBase {
}
"""
