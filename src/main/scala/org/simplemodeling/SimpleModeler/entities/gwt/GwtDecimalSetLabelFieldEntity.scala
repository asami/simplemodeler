 ...
 */
class GwtDecimalSetLabelFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class DecimalSetLabelField extends ValueSetLabelFieldBase {
}
"""
