 ...
 */
class GwtDoubleSetInputFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class DoubleSetInputField extends ValueSetInputFieldBase {
}
"""
