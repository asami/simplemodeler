 ...
 */
class GwtBooleanSetInputFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class BooleanSetInputField extends ValueSetInputFieldBase {
}
"""
