 ...
 */
class GwtFloatSetLabelFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class FloatSetLabelField extends ValueSetLabelFieldBase {
}
"""
