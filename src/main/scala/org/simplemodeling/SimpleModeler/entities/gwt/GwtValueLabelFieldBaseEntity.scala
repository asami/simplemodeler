 ...
 */
class GwtValueLabelFieldBaseEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public abstract class ValueLabelFieldBase extends Label implements ILabelField {
	@Override
