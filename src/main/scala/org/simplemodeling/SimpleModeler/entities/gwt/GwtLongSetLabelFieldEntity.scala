 ...
 */
class GwtLongSetLabelFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class LongSetLabelField extends ValueSetLabelFieldBase {
}
"""
