 ...
 */
class GwtIntegerSetLabelFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class IntegerSetLabelField extends ValueSetLabelFieldBase {
}
"""
