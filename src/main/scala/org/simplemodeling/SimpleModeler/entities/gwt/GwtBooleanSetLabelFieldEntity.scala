 ...
 */
class GwtBooleanSetLabelFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class BooleanSetLabelField extends ValueSetLabelFieldBase {
}
"""
