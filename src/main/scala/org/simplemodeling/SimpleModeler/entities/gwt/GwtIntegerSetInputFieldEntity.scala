 ...
 */
class GwtIntegerSetInputFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class IntegerSetInputField extends ValueSetInputFieldBase {
}
"""
