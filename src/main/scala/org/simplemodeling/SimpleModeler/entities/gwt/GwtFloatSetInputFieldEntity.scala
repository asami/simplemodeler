 ...
 */
class GwtFloatSetInputFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class FloatSetInputField extends ValueSetInputFieldBase {
}
"""
