 ...
 */
class GwtStringSetLabelFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class StringSetLabelField extends ValueSetLabelFieldBase {
}
"""
