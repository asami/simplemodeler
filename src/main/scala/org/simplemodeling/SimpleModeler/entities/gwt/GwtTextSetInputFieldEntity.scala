 ...
 */
class GwtTextSetInputFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class TextSetInputField extends ValueSetInputFieldBase {
}
"""
