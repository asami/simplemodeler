 ...
 */
class GwtDoubleSetLabelFieldEntity(val gwtContext: GwtEntityContext) extends GEntity(gwtContext) {
...
public class DoubleSetLabelField extends ValueSetLabelFieldBase {
}
"""
