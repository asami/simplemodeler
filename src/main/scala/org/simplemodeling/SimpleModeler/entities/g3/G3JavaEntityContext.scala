...
import org.simplemodeling.SimpleModeler.entities.java6.Java6EntityContext
 ...
 */
class G3JavaEntityContext(ectx: GEntityContext, sctx: GServiceContext) extends JavaEntityContextBase(ectx, sctx) {
}
